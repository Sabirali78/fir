...
// Query to get Pending NOC details
$pending_query = "SELECT * FROM ncs WHERE status = 'Pending'";
$pending_result = mysqli_query($conn, $pending_query);

// Query to get In Progress NOC details
$in_progress_query = "SELECT * FROM ncs WHERE status = 'In Progress'";
$in_progress_result = mysqli_query($conn, $in_progress_query);

// Query to get Resolved NOC details
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">In Progress NOCs</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table student-data-table m-t-20">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($in_progress_result)) : ?>
                            <tr>
                                <td class="py-2 px-4 border-b"><?php echo $row['id']; ?></td>
                                <td class="py-2 px-4 border-b"><?php echo $row['user_id']; ?></td>
                                <td class="py-2 px-4 border-b"><?php echo $row['title']; ?></td>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table student-data-table m-t-20">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($resolved_result)) : ?>
                            <tr>
                                <td class="py-2 px-4 border-b"><?php echo $row['id']; ?></td>
                                <td class="py-2 px-4 border-b"><?php echo $row['user_id']; ?></td>
                                <td class="py-2 px-4 border-b"><?php echo $row['title']; ?></td>
